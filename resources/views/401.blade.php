...
<head>
  ...
  <title>401 Error</title>
    ...
    <style>
        #oopss {
            background: linear-gradient(-45deg, #ff3368, #e6003d);
            position: fixed;
            left: 0px;
            top: 0;
            width: 100%;
        ...
        #oopss #error-text .back {
            ...
            padding: .7em 2em;
            border-radius: 500px;
            box-shadow: 0 20px 70px 4px rgba(0, 0, 0, 0.1), inset 7px 33px 0 0px #ff3368;
            font-weight: 900;
...
<body>
  ...
  <div id='oopss'>
    <div id='error-text'>
        ...
        <span>401 PAGE</span>
        <p class="p-a">
           . You do not have the necessary authorization to access the requested resource. Please provide valid authentication credentials or contact support for assistance .</p>
        <p class="p-b">
