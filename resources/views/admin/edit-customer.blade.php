        ...
        <form class="forms-sample" method="POST" action="/edit_password/{{$user->id}}" >
          ...
          <div class="form-group">
            ...
            <div class="input-group">
              <input type="password" name="current_password" class="form-control" id="exampleInputPassword4" placeholder="Enter Current Password" @if (\Session::has('error')) autofocus @endif>
              <button class="btn btn-outline-secondary" type="submit" id="button-addon">Change</button>
            </div>
          ...
          <div class="form-group">
            ...
            <div class="input-group">
              <input type="password" name="password" class="form-control" id="exampleInputNewPassword" placeholder="New Password" autofocus >
              <span class="field-icon input-group-text"><i class="fa fa-fw fa-eye toggle-password" toggle="#exampleInputNewPassword"></i></span>
            </div>
          ...
          <div class="form-group">
            ...
            <div class="input-group">
              <input type="password" name="password_confirmation" class="form-control" id="exampleInputConfirmPassword" placeholder="Confirm Password" value="">
              <span class="field-icon input-group-text"><i class="fa fa-fw fa-eye toggle-password" toggle="#exampleInputConfirmPassword"></i></span>
            </div>
