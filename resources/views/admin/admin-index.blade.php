...
@section('content')
    ...
    <div class="row">
        ...
        <div class="card">
            <div class="card-body">
            <h4 class="card-title">Sales Analysis of Popular Car Makes</h4>
        ...
        $(function() {
                        ...
                        tooltips: {
                            callbacks: {
                                label: function(tooltipItem, data) {
                                    ...
                                    var salesIncome = {{ json_encode($salesIncome) }};
            ...
            if ($("#traffic-chart").length) {
                ...
                var trafficChartData = {
                    datasets: [{
                    data: <?= json_encode(array_values($popularCar)) ?>,
                    backgroundColor: [
                        gradientStrokeBlue,
                        gradientStrokeGreen,
                        gradientStrokeRed,
                    ...
                    labels: <?= json_encode(array_keys($popularCar)) ?>
                };
